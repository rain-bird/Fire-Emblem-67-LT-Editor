...
#Altered to be a unit-based command, as funds are now unit specific.
class GiveMoney(EventCommand):
    ...
    desc = \
        """
Gives *Money* to the indicated *Unit*. Unit *must* be specified.
If the *no_banner* flag is set, there will not be a banner announcing that "unit received X gold!".
        """
        
    keywords = ["GlobalUnit", "Money"]
